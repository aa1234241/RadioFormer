    ...
    for patientID in tqdm(data):
        ...
        for phase in phases:
            ...
            for ann_idx in annotation:
                ...
                # roi = np.transpose(roi,axes=(0,2,1))
                ...
                nii_file.SetOrigin(image.GetOrigin())
                nii_file.SetSpacing(image.GetSpacing())
                nii_file.SetDirection(image.GetDirection())
...
if __name__ == "__main__":
    ...
    save_dir = '/media/xiaoyubai/raw_data/lld_mmri/data/classification_dataset/images_mycrop_8_spacing/'
