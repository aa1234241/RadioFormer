...
class ResNetM(nn.Module):
    ...
    def __init__(
        ...
        #
        # self.fc2 = nn.Linear(self.num_features*8,self.num_features//2,bias=False)
        # self.fc3 = nn.Linear(self.num_features//2,self.num_classes,bias=True)
