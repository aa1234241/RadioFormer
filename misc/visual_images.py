...
all_cases_path = '/media/xiaoyubai/raw_data/lld_mmri/lldmmri_test_set/images-recover-registered/'
all_cases = os.listdir(all_cases_path)
save_path = '/media/xiaoyubai/raw_data/lld_mmri/lldmmri_test_set/visual-original-registered'
